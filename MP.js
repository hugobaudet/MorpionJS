...
let scorehugo = document.getElementById("scorehugo");
let scorevoisin = document.getElementById("scorevoisin");
...
const jouerCase = (e) => {
  ...
  if (isVctoire === true) {
    ...
    if (state.joueurEnCours == 1) {
      state.scoreJ1++;
      scorehugo.textContent = state.scoreJ1;
    } else {
      state.scoreJ2++;
      scorevoisin.textContent = state.scoreJ2;
    }
    ...
    alert("La banque s'enrichie !");

    state.scorebanque++;
    scorebanque.textContent = state.scorebanque;
    ...
    if (state.joueurEnCours == 1) {
      ...
      joueur.textContent = "Voisin";
    } else {
      state.joueurEnCours = 1;
      e.target.textContent = "V";
      joueur.textContent = "Hugo";
    }
  }
};
